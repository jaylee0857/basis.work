<template>
  ...
  <section class="section">
    ...
    <div class="container">
      ...
      <div class="sticky-pair">
        <div class="w-layout-grid pair-grid">
          <div id="w-node-eb3e6ea8-5a10-d5fc-f561-3f621ba6f385-af552307">
            <div
  ...
  <section class="section">
    ...
    <div class="container">
      <div class="w-layout-grid pair-grid">
        <div id="w-node-_6e6a6411-9d71-b91d-1723-e94f35341c18-af552307">
    ...
    <footer class="footer">
      <div class="container">
        <div class="row row-justify-center">
          <div class="col col-lg-3 col-md-12">
            ...
            <div class="footer_group">
              <h3 class="u-ts-6 u-text-secondary">Social</h3>
              <ul role="list" class="footer_list">
                <li class="footer_list-item">
                  <a
          ...
          <div class="col col-lg-3 col-md-12">
            <div class="footer_group">
              ...
              <ul role="list" class="footer_list">
                ...
                <li class="footer_list-item">
                  <a href="/fintech-design" class="footer_link w-inline-block"
          ...
          <div class="col col-lg-4 col-md-12 col-md-first">
            <a
              href="/"
              aria-current="page"
              class="footer-wordmark w-inline-block w--current"
        ...
        <div class="footer-copyright">
          <div data-copyright="">
            Copyright © <span data-dynamic="year">2024</span>
          </div>
        </div>
      </div>
    </footer>
